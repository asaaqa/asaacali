...
try:
    ...
    LOGS.error("bot: 'gitpython' لم يتم العثور على!")
    Repo = None
...
async def _(e):
    ...
    if m:
        ...
        await xx.edit(
            f'<code>الروبوت الخاص بك هو</code><strong>up-to-date</strong><code> with </code><strong><a href="https://github.com/asaaqa/asaacali/tree/{branch}">[{branch}]</a></strong>',
            parse_mode="html",
            link_preview=False,
        )
